...
// Simple in-memory cache for IP geolocation (no longer used; kept for future)
const ipGeoCache = {};
...
async function buildGeoMarkers(events) {
    // Use geoPoints from backend for map markers
    const markers = [];
...
async function fetchStats() {
    try {
        ...
        // Geo-IP points from backend (geoPoints)
        window.latestGeoIPs = data.geoPoints || [];
        ...
        // Swallow errors for now (dashboard should fail gracefully)
